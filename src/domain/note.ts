...
const C1_MIDI_NUMBER: number = 24;
const C4_MIDI_NUMBER: number = 60;
const B5_MIDI_NUMBER: number = 83;

export const LOWER_NOTE = C4_MIDI_NUMBER;
export const HIGHER_NOTE = B5_MIDI_NUMBER;
export const SEMITONES_IN_OCTAVE: number = 12;
...
export interface NotesGeneratorSettings {
  fromNote?: MidiValue;
  toNote?: MidiValue;
}
